...
ath.intl = {
	...
	en_us: {
		ios: 'Add this web app to the home screen: tap %icon and then <strong>Add to Home Screen</strong>.',
		android: 'To add this web app to the home screen open the browser option menu and tap on <strong>Add to homescreen</strong>.',
	},
    
    da_dk: {
		ios: 'Tilføj denne side til din hjemmeskærm ved at klikke på: %icon og derefter <strong>Føj til hjemmeskærm</strong>.',
		android: 'For at tilføje denne side til hjemmeskærm, åben browserens option menu og klik på <strong>Tilføj til hjemmeskærm</strong>.',
	},
